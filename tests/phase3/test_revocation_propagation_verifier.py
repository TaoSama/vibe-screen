...
class RevocationPropagationVerifierTests(unittest.TestCase):
    ...
    def complete_report(self) -> dict[str, object]:
        return {
            ...
            "source": {
                "commit": "c5add121d4ebebaa0083db64551a81ec7899696e",
                "topology": "staging",
            ...
            "relay_credential": {
                ...
                "new_credential_status": 403,
                "stale_credential_reuse_rejected": True,
                "stale_credential_status": 486,
    ...
    def test_secret_fields_are_rejected_before_evaluation(self) -> None:
        report = self.complete_report()
        report["relay_credential"] = dict(report["relay_credential"], password="do-not-store")
