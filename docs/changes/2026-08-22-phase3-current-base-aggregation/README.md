...
Current base audited: `f46163524fe757e7021a4333b3370af00ec651f1`
(`origin/main`, 2026-08-26)
...
| --- | --- | --- | --- |
| Current `origin/main` | `f46163524fe757e7021a4333b3370af00ec651f1` | Source contains the local Phase 3 product slice, production WebRTC adapters, application-record protection, local Authority/signaling/relay scaffolding, signaling multi-node waiter recovery, coturn reconciliation product-slice code, network handoff fresh-session code, revocation propagation gates, real-media/adaptive/DataChannel readiness gates, and the generated current-base release-gate summary. | No current public Internet release pass is recorded. Current evidence remains local, synthetic, historical, or blocked unless a named gate says otherwise. |
...
| PR | Current status on 2026-08-26 | Disposition | Reason |
| --- | --- | --- | --- |
...
| #215 Add production Postgres signaling store slice | Open draft; conflicting. | Supersede by merged signaling multi-node work after checking for any unique PRD/TEST/static assertions. | #223 and later mainline service changes are the current signaling baseline. |
...
2. Close or supersede stale broad PRs after unique-diff checks: #164, #188, #194,
   #212, #214, #215, and #254. Do not close them merely because this audit says
