# 2026-08-31 current-base Host RSS fail-closed readiness
...
`075dc157c36ba71df9f757e571015905881a7154`. It does not include a 10-17 minute
...
- `scripts/macos_dev_host.py readiness` exited `2` from a clean source checkout
  and wrote `status=blocked`, `can_start_host_rss_gate=false`,
  `host.current_source_commit=075dc157c36ba71df9f757e571015905881a7154`,
