...
Status: 5A–5D client implementation complete; host/iOS verification blocked  
...
| --- | --- | --- | --- |
| 5A | single iOS client, existing display, one video stream, touch | existing Protocol v1 only | code complete; iOS SDK/device unverified |
...
Criterion 1 and Protocol v1 backward compatibility are currently proved. Android ADB evidence can prove
cross-client contract behavior but cannot satisfy criteria 2 or 3.
