...
is not wired to Authority, the current relay/coturn deployment does not call
Authority relay admission or coturn usage APIs, and no integrated implementation
has run on a public host in this environment.
