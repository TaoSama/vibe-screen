...
open both re-read the peer-scoped active epoch before nonce, replay, AEAD, or
commit work. The prior curated Android/macOS device interop pass is withdrawn:
