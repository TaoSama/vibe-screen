...
currently asks the operator to supply that fresh profile; automatic authority
issuance and macOS/Android device proof of the complete handoff remain release
gates.
