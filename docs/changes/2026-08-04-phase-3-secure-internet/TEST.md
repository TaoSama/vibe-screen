...
- A 2026-08-25 current-base product slice makes validated network handoff request
  ...
  This is unit/contract evidence only. It predates the 2026-09-16 P0110
  no-Host MainActivity UI import/bootstrap smoke and does not prove production
  Authority-issued Android bootstrap, public Internet, real ScreenCaptureKit
