...
Base: origin/main at d8f108aaded3a05708587c721186cf0737bc4dfa
...
returned PR #708 at refresh time. No required Phase 0 aggregate gate lists an
active owner PR in this refresh. PR #702, PR #703, PR #705, PR #706, and PR #707
are now merged into the audited mainline input after the previous checked-in
aggregate refresh. PR #702 is the aggregate refresh after PR #701, PR #703
refreshes P0110 no-Host UI/UX current-main evidence after PR #700, PR #705
hardens controller runtime artifact evidence paths, PR #706 hardens Host RSS
readiness safety checks, and PR #707 clarifies macOS compatibility TCC gates. The
PR #705 merge commit matches this audited base.
Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #707
...
through PR #626, and PR #628 through PR #707 after the unmerged exclusions
...
metadata validation, and macOS compatibility TCC documentation/source-guard
clarification.
...
| Protocol v1 contract and CI gates | pass | none | Current main at `d8f108aaded3a05708587c721186cf0737bc4dfa` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence; the after-707 evidence bundle also records current-main workflow metadata for this audited source. These CI snapshots are not counted as new Host-backed product evidence. |
| Android tests and debug APK clean build | pass | none | Current main at `d8f108aaded3a05708587c721186cf0737bc4dfa` includes the earlier source/unit/offline/tooling and no-Host readiness updates plus PR #702, PR #703, PR #705, PR #706, and PR #707. The new PR range contributes aggregate refresh evidence, no-Host UI/UX evidence, controller runtime artifact evidence path hardening, Host RSS readiness safety-check hardening, and macOS compatibility TCC documentation/source-guard clarification. These updates are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `d8f108aaded3a05708587c721186cf0737bc4dfa` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence, while local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected and is not a replacement XCTest pass. |
...
| Android USB stream, reconnect, stale epoch, and codec fallback | pass | none | Closed by retained historical real-device baseline evidence; current-base insufficient attempts remain boundary records and do not claim a fresh USB pass. Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #707 add source/unit/offline, tooling, aggregate, or no-Host readiness evidence, but those records are not counted as stream/reconnect, LAN route, TCP 54321, Host-backed product, physical HID pointer, controller, or retained device evidence. |
...
#702 contributes aggregate refresh evidence only. PR #703 contributes Nubia
P0110/pacific no-Host UI/UX current-main evidence only. PR #706 contributes
Host RSS readiness safety-check hardening only.
...
`d8f108aaded3a05708587c721186cf0737bc4dfa`, records open non-owner PR #708, records merged
PR #569 through PR #575, PR #577 through PR #626, and
PR #628 through PR #707 as `main`-targeted source/unit/offline, tooling,
...
through PR #707 contribute only aggregate, README, source, tooling,
...
complete audited PR #568 through PR #707 range because they are not merged in the
audited mainline base. The retained current
refresh summary bundle is under
`evidence/2026-09-09-after-707-current-main-gate-blocked/`; local verification
