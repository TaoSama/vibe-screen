...
Base: origin/main at 0fbe6e7fced0fdabd4ba667fe7715dc20057e1e3
...
returned PR #701 and PR #702 at refresh time. No required Phase 0 aggregate gate
lists an active owner PR in this refresh. PR #698, PR #699, PR #700, and PR
#703 are now merged into the audited mainline input after the previous
aggregate refresh. PR #698 is the aggregate refresh after PR #697; PR #700 is
the macOS Host compatibility row requirement merge; PR #703 contributes Nubia
P0110/pacific no-Host UI/UX evidence and is the merge commit that matches this
audited base.
Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #703
...
without merging, and PR #701 and PR #702 remained open at refresh time, so they
are explicitly excluded from the audited merged range.
Audited merged PRs in this range include PR #569 through PR #575, PR #577
through PR #626, and PR #628 through PR #703 after the unmerged exclusions
...
accessibility source coverage, and further fail-closed hardening for
file-transfer product E2E, clipboard E2E, native pointer HID, macOS Host
compatibility, controller runtime, Host RSS, telemetry latency archive evidence
gates, and a formal macOS Host compatibility passing-row requirement.
...
| Protocol v1 contract and CI gates | pass | none | Current main at `0fbe6e7fced0fdabd4ba667fe7715dc20057e1e3` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence; the after-703 evidence bundle also records current-main workflow metadata for this audited source. These CI snapshots are not counted as new Host-backed product evidence. |
| Android tests and debug APK clean build | pass | none | Current main at `0fbe6e7fced0fdabd4ba667fe7715dc20057e1e3` includes the earlier source/unit/offline/tooling and no-Host readiness updates plus PR #698 through PR #703. The new PR range contributes aggregate refresh evidence, fail-closed macOS Host compatibility artifact and formal passing-row gate hardening, and PR #703 Nubia P0110/pacific no-Host UI/UX evidence. These updates are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `0fbe6e7fced0fdabd4ba667fe7715dc20057e1e3` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence, while local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected and is not a replacement XCTest pass. |
...
PR #703 contributes Nubia P0110/pacific no-Host UI/UX current-main evidence only.
...
`0fbe6e7fced0fdabd4ba667fe7715dc20057e1e3`, records open non-owner PR #701 and PR #702, records merged
PR #569 through PR #575, PR #577 through PR #626, and
PR #628 through PR #703 as `main`-targeted source/unit/offline, tooling,
...
E2E gates. PR #568, PR #576, PR #627, PR #646, PR #655, PR #701, and PR #702 are
explicitly excluded from the complete audited PR #568 through PR #703 range
because they are not merged in the audited mainline base. The retained current
refresh summary bundle is under
`evidence/2026-09-08-after-703-current-main-gate-blocked/`; local verification
