...
Base: origin/main at 75c2e551d84d11009901a69ad8499a03048da595
...
an active owner PR in this refresh. PR #722 and PR #723 are now merged into the
audited mainline input after the previous checked-in aggregate refresh. PR #722
refreshes the aggregate after PR #721, and PR #723 covers no-Host wireless LAN
panel state instrumentation without adding Host-backed product evidence.
Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #723
...
through PR #626, and PR #628 through PR #723 after the unmerged exclusions
...
and wireless LAN panel state instrumentation coverage.
...
| Protocol v1 contract and CI gates | pass | none | Current main at `75c2e551d84d11009901a69ad8499a03048da595` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence; the after-723 evidence bundle also records main workflow metadata for this audited source. These CI snapshots are not counted as new Host-backed product evidence. |
| Android tests and debug APK clean build | pass | none | Current main at `75c2e551d84d11009901a69ad8499a03048da595` includes the earlier source/unit/offline/tooling and no-Host readiness updates plus PR #722 and PR #723. The new PR range contributes aggregate refresh evidence and no-Host wireless LAN panel state instrumentation coverage. These updates are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `75c2e551d84d11009901a69ad8499a03048da595` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence, while local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected and is not a replacement XCTest pass. |
...
| Android USB stream, reconnect, stale epoch, and codec fallback | pass | none | Closed by retained historical real-device baseline evidence; current-base insufficient attempts remain boundary records and do not claim a fresh USB pass. Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #723 add source/unit/offline, tooling, aggregate, or no-Host readiness evidence, but those records are not counted as stream/reconnect, LAN route, TCP 54321, Host-backed product, physical HID pointer, controller, or retained device evidence. |
...
wireless LAN panel state instrumentation coverage only.
...
`75c2e551d84d11009901a69ad8499a03048da595`, records no open PRs, records merged
PR #569 through PR #575, PR #577 through PR #626, and
PR #628 through PR #723 as `main`-targeted source/unit/offline, tooling,
...
through PR #723 contribute only aggregate, README, source, tooling,
...
complete audited PR #568 through PR #723 range because they are not merged in the
audited mainline base. The retained current
refresh summary bundle is under
`evidence/2026-09-09-after-723-current-main-gate-blocked/`; local verification
