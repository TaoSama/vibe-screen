...
Base: origin/main at b10c933ffc63808eadaa2ca2bd329aa696eb43a8
...
returned current open PR #639. PR #638 is now merged into the audited
mainline input, along with PR #634 through PR #637. Merged PR
#569 through PR #575, PR #577 through PR #626, and PR #628 through PR #638 were collected with `--base main`,
...
audited input. PR #568, PR #576, and PR #627 were closed without merging, so
they are explicitly excluded from the audited merged range. Merged PR #569
through PR #575, PR #577 through PR #626, and PR #628 through PR #638 include additional Android no-Host
UI/layout evidence,
...
domain isolation, Android network-down connection guidance, and P0110 no-Host
...
| Protocol v1 contract and CI gates | pass | none | Current main at `b10c933ffc63808eadaa2ca2bd329aa696eb43a8` passed the Phase 0 checks workflow run `34045280984`, including protocol, phase3, Android, evidence-tools, and macOS jobs. |
| Android tests and debug APK clean build | pass | none | Current main at `b10c933ffc63808eadaa2ca2bd329aa696eb43a8` passed the Android job in Phase 0 checks workflow run `34045280984`; merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #638 add focused Android verification and no-Host/source readiness, including PR #621 host-unreachable/route-unavailable guidance JVM coverage, PR #622/#624/#626/#628/#629/#630/#634 aggregate evidence refreshes, PR #623 P0110 no-Host UI/UX review evidence, PR #625 Host TCC identity preflight tightening, PR #631 telemetry latency evidence gate hardening, PR #632 Host RSS telemetry coverage hardening, PR #633 no-Host Android UI check stabilization, PR #635 phase0 evidence guidance hardening, PR #636 Android audio protocol contract hardening, PR #637 input move coalescing domain isolation, and PR #638 Android network-down connection guidance, but are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `b10c933ffc63808eadaa2ca2bd329aa696eb43a8` passed the macOS job in Phase 0 checks workflow run `34045280984`. Local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected, so it is not a replacement XCTest pass. |
...
| Android USB stream, reconnect, stale epoch, and codec fallback | pass | none | Closed by retained historical real-device baseline evidence; current-base insufficient attempts remain boundary records and do not claim a fresh USB pass. Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #638 add Android no-Host UI, keyboard, clipboard, audio, AV1, controller, managed-policy, file-transfer, aggregate evidence, host-unreachable guidance, network-down guidance, P0110 no-Host UI/UX review, telemetry/Host RSS gate hardening, Host TCC identity preflight, phase0 guidance, and input coalescing source/unit/offline readiness, but those records are not counted as stream/reconnect, LAN route, TCP 54321, Host-backed product, or retained device evidence. |
...
`b10c933ffc63808eadaa2ca2bd329aa696eb43a8`, records the current open-PR
snapshot as PR #639, consumes current-main Phase 0
checks run `34045280984`, records merged PR #569 through PR #575, PR #577
through PR #626, and PR #628 through PR #638 as `main`-targeted source/unit/offline or no-Host readiness after
validating each recorded
...
gates that are blocked. PR #568, PR #576, and PR #627 were closed without
merging, so they are explicitly excluded from the audited merged range.
