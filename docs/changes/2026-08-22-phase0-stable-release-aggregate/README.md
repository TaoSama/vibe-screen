...
Base: origin/main at a3fbc0f52ab14b119995fe1c63858f901a052ba6
...
returned only this refresh PR #622 as open. It is not listed as a required-gate
owner in the manifest. Merged PR #569 through PR #575 and PR #577 through PR
#621 landed in the audited mainline base. PR #568 and PR #576 were
closed without merging and are not included in the audited mainline base. Merged
PR #569 through PR #575 and PR #577 through PR #621 include additional Android
...
guidance JVM coverage, and WakeHost or actionable-error gate documentation
fixes. These are recorded as source/unit/offline or no-Host readiness only. They
...
| Protocol v1 contract and CI gates | pass | none | Current main at `a3fbc0f52ab14b119995fe1c63858f901a052ba6` passed the Phase 0 checks workflow run `34007427903`, including protocol, phase3, Android, evidence-tools, and macOS jobs. |
| Android tests and debug APK clean build | pass | none | Current main at `a3fbc0f52ab14b119995fe1c63858f901a052ba6` passed the Android job in Phase 0 checks workflow run `34007427903`; merged PR #569 through PR #575 and PR #577 through PR #621 add focused Android verification and no-Host/source readiness, including PR #621 host-unreachable/route-unavailable guidance JVM coverage, but are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `a3fbc0f52ab14b119995fe1c63858f901a052ba6` passed the macOS job in Phase 0 checks workflow run `34007427903`. Local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected, so it is not a replacement XCTest pass. |
...
| Android USB stream, reconnect, stale epoch, and codec fallback | pass | none | Closed by retained historical real-device baseline evidence; current-base insufficient attempts remain boundary records and do not claim a fresh USB pass. Merged PR #569 through PR #575 and PR #577 through PR #621 add Android no-Host UI, keyboard, clipboard, audio, AV1, controller, managed-policy, file-transfer, and host-unreachable guidance source/unit/offline readiness, but those records are not counted as stream/reconnect, LAN route, TCP 54321, Host-backed product, or retained device evidence. |
...
`a3fbc0f52ab14b119995fe1c63858f901a052ba6`, records the current open-PR
snapshot containing only PR #622 while keeping all required gate `owner_prs`
lists empty, consumes current-main Phase 0 checks run `34007427903`, records
merged PR #569 through PR #575 and PR #577 through PR #621 as source/unit/offline
