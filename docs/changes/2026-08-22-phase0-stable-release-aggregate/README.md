...
Base: origin/main at 939472bf2bb59e76fce46e4ac176aefd05e61d7c
...
returned PR #702 at refresh time. No required Phase 0 aggregate gate lists an
active owner PR in this refresh. PR #698, PR #699, PR #700, PR #701, and PR #703
are now merged into the audited mainline input after the previous aggregate
refresh. PR #698 is the aggregate refresh after PR #697; PR #700 is the macOS
Host compatibility row requirement merge; PR #701 hardens latency artifact
closure checks; and PR #703 contributes Nubia P0110/pacific no-Host UI/UX
evidence. The PR #701 merge commit matches this audited base.
...
without merging, and PR #702 remained open at refresh time, so they are
...
| Protocol v1 contract and CI gates | pass | none | Current main at `939472bf2bb59e76fce46e4ac176aefd05e61d7c` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence; the after-701 evidence bundle also records current-main workflow metadata for this audited source. These CI snapshots are not counted as new Host-backed product evidence. |
| Android tests and debug APK clean build | pass | none | Current main at `939472bf2bb59e76fce46e4ac176aefd05e61d7c` includes the earlier source/unit/offline/tooling and no-Host readiness updates plus PR #698 through PR #703. The new PR range contributes aggregate refresh evidence, fail-closed macOS Host compatibility artifact and formal passing-row gate hardening, PR #701 latency artifact closure hardening, and PR #703 Nubia P0110/pacific no-Host UI/UX evidence. These updates are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `939472bf2bb59e76fce46e4ac176aefd05e61d7c` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence, while local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected and is not a replacement XCTest pass. |
...
#703 contributes Nubia P0110/pacific no-Host UI/UX current-main evidence only.
...
`939472bf2bb59e76fce46e4ac176aefd05e61d7c`, records open non-owner PR #702, records merged
...
E2E gates. PR #568, PR #576, PR #627, PR #646, PR #655, and PR #702 are
...
`evidence/2026-09-09-after-701-current-main-gate-blocked/`; local verification
