...
| Host RSS two-hour no-growth | blocked | #158, #195, #222, #230, #237, #260, #329, #376, #387 | The retained two-hour Xiaomi 13 run grew about 18.3 MB. The latest current-base readiness records prove fail-closed diagnostics only and are still blocked before a stable-signed Host can produce native telemetry and a current-source two-hour `host_rss_gate` pass. |
