...
| Host RSS two-hour no-growth | blocked | #158, #195, #222, #230, #237, #260, #329 | The retained two-hour Xiaomi 13 run grew about 18.3 MB; the latest current-base readiness records are still blocked before a stable-signed Host can produce native telemetry; no current-source host_rss_gate pass exists. |
