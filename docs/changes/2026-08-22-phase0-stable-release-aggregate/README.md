...
Base: origin/main at fdf87a225127d2b2f43b201e3c44dda8d49e64d7
...
returned no open PRs. PR #640, PR #641, and PR #642 are now merged into the
audited mainline input after the previous aggregate refresh. Merged PR
#569 through PR #575, PR #577 through PR #626, and PR #628 through PR #642 were collected with `--base main`,
...
through PR #575, PR #577 through PR #626, and PR #628 through PR #642 include additional Android no-Host
UI/layout evidence,
...
peripheral input payload snapshotting, Android audio jitter gap recovery, and
P0110 no-Host UI/UX review evidence.
...
| Protocol v1 contract and CI gates | pass | none | Current main at `fdf87a225127d2b2f43b201e3c44dda8d49e64d7` is bound by this source audit. At evidence-query time, the new Phase 0 checks workflow was still in progress, so this row still relies on the prior current-main pass at `b10c933ffc63808eadaa2ca2bd329aa696eb43a8` / run `34045280984` rather than treating in-progress CI as a new pass. |
| Android tests and debug APK clean build | pass | none | Current main at `fdf87a225127d2b2f43b201e3c44dda8d49e64d7` includes PR #640 peripheral input payload snapshotting, PR #642 Host setup guidance classification, and PR #641 Android audio jitter gap recovery. These are source/unit/offline readiness updates and are not treated as Host-backed product evidence; at evidence-query time, the new Phase 0 checks workflow was still in progress, so the row still relies on the prior current-main Android pass at `b10c933ffc63808eadaa2ca2bd329aa696eb43a8` / run `34045280984`. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `fdf87a225127d2b2f43b201e3c44dda8d49e64d7` is bound by this source audit. At evidence-query time, the new Phase 0 checks workflow was still in progress, so this row still relies on the prior current-main macOS pass at `b10c933ffc63808eadaa2ca2bd329aa696eb43a8` / run `34045280984`. Local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected, so it is not a replacement XCTest pass. |
...
| Android USB stream, reconnect, stale epoch, and codec fallback | pass | none | Closed by retained historical real-device baseline evidence; current-base insufficient attempts remain boundary records and do not claim a fresh USB pass. Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #642 add Android no-Host UI, keyboard, clipboard, audio, AV1, controller, managed-policy, file-transfer, aggregate evidence, host-unreachable/network-down/Host setup guidance, P0110 no-Host UI/UX review, telemetry/Host RSS gate hardening, Host TCC identity preflight, phase0 guidance, input coalescing, peripheral payload snapshotting, and audio jitter recovery source/unit/offline readiness, but those records are not counted as stream/reconnect, LAN route, TCP 54321, Host-backed product, or retained device evidence. |
...
`fdf87a225127d2b2f43b201e3c44dda8d49e64d7`, records an empty open-PR
snapshot, records merged PR #569 through PR #575, PR #577 through PR #626, and
PR #628 through PR #642 as `main`-targeted source/unit/offline or no-Host
...
and PR #627 were closed without merging, so they are explicitly excluded from
the audited merged range. The retained current refresh summary
bundle is under `evidence/2026-09-07-current-main-gate-blocked/`; local
