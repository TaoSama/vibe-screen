...
Base: origin/main at 8847de12b09bece64e7eadd7258b9703bb6bb271
...
recorded only this aggregate refresh PR (#719) as open at refresh time. No
required Phase 0 aggregate gate lists an active owner PR in this refresh. PR
#714 through PR #718 and PR #720 are now merged into the audited mainline input
after the previous checked-in aggregate refresh. PR #714 refreshes the aggregate
after PR #713, PR #715 hardens macOS TCC latest-row preflight coverage, PR #716
refreshes P0110 no-Host UI/UX evidence, PR #717 fixes after-713 UI/UX evidence
notes, PR #718 preserves wireless and QR UI safeguards, and PR #720 preserves
no-Host UI accessibility coverage without adding Host-backed product evidence.
Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #720
...
without merging, PR #704 was closed without merging, and PR #719 is this open
aggregate refresh PR, so they are explicitly excluded from the audited merged
range.
Audited merged PRs in this range include PR #569 through PR #575, PR #577
through PR #626, and PR #628 through PR #720 after the unmerged exclusions
...
preflight coverage, and P0110 no-Host UI/UX evidence note refreshes.
...
| Protocol v1 contract and CI gates | pass | none | Current main at `8847de12b09bece64e7eadd7258b9703bb6bb271` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence; the after-720 evidence bundle also records completed current-main workflow metadata for this audited source. These CI snapshots are not counted as new Host-backed product evidence. |
| Android tests and debug APK clean build | pass | none | Current main at `8847de12b09bece64e7eadd7258b9703bb6bb271` includes the earlier source/unit/offline/tooling and no-Host readiness updates plus PR #714 through PR #718 and PR #720. The new PR range contributes aggregate refresh evidence, macOS TCC latest-row preflight coverage, no-Host UI/UX evidence note refreshes, wireless and QR UI safeguards, accessibility coverage, and fail-closed evidence-tool hardening. These updates are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `8847de12b09bece64e7eadd7258b9703bb6bb271` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence, while local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected and is not a replacement XCTest pass. |
...
| Android USB stream, reconnect, stale epoch, and codec fallback | pass | none | Closed by retained historical real-device baseline evidence; current-base insufficient attempts remain boundary records and do not claim a fresh USB pass. Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #720 add source/unit/offline, tooling, aggregate, or no-Host readiness evidence, but those records are not counted as stream/reconnect, LAN route, TCP 54321, Host-backed product, physical HID pointer, controller, or retained device evidence. |
...
tests only. PR #720 contributes no-Host Android UI accessibility coverage only.
...
`8847de12b09bece64e7eadd7258b9703bb6bb271`, records only aggregate refresh PR
#719 as an open non-owner PR, records merged
PR #569 through PR #575, PR #577 through PR #626, and
PR #628 through PR #720 as `main`-targeted source/unit/offline, tooling,
...
through PR #720 contribute only aggregate, README, source, tooling,
...
PR #576, PR #627, PR #646, PR #655, PR #704, and PR #719 are explicitly excluded from the
complete audited PR #568 through PR #720 range because they are not merged in the
audited mainline base. The retained current
refresh summary bundle is under
`evidence/2026-09-09-after-720-current-main-gate-blocked/`; local verification
