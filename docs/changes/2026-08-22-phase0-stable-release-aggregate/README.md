...
Base: origin/main at be950a5e4e6c7415800f284b368d4b8cf6db3be8
...
an active owner PR in this refresh. PR #698 through PR #700 are now merged into
the audited mainline input after the previous aggregate refresh. PR #698 is the
aggregate refresh after PR #697; PR #700 is the macOS Host compatibility row
requirement merge commit that matches this audited base.
Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #700
...
Merged
PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #700
...
| Protocol v1 contract and CI gates | pass | none | Current main at `be950a5e4e6c7415800f284b368d4b8cf6db3be8` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence; the after-700 evidence bundle also records current-main workflow metadata for this audited source. These CI snapshots are not counted as new Host-backed product evidence. |
| Android tests and debug APK clean build | pass | none | Current main at `be950a5e4e6c7415800f284b368d4b8cf6db3be8` includes the earlier source/unit/offline/tooling and no-Host readiness updates plus PR #698 through PR #700. The new PR range contributes aggregate refresh evidence plus fail-closed macOS Host compatibility artifact and formal passing-row gate hardening. These updates are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `be950a5e4e6c7415800f284b368d4b8cf6db3be8` is bound by this source audit. Previously retained successful CI snapshots remain source/build evidence, while local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected and is not a replacement XCTest pass. |
...
| Android USB stream, reconnect, stale epoch, and codec fallback | pass | none | Closed by retained historical real-device baseline evidence; current-base insufficient attempts remain boundary records and do not claim a fresh USB pass. Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #700 add source/unit/offline, tooling, aggregate, or no-Host readiness evidence, but those records are not counted as stream/reconnect, LAN route, TCP 54321, Host-backed product, physical HID pointer, controller, or retained device evidence. |
...
`be950a5e4e6c7415800f284b368d4b8cf6db3be8`, records no open non-owner PRs, records merged
PR #569 through PR #575, PR #577 through PR #626, and
PR #628 through PR #700 as `main`-targeted source/unit/offline, tooling,
...
#681 through PR #700 contribute only aggregate, README, source, tooling,
...
excluded from the complete audited PR #568 through PR #700 range because they
are closed without merging in the audited mainline base. The retained current
refresh summary bundle is under
`evidence/2026-09-08-after-700-current-main-gate-blocked/`; local verification
