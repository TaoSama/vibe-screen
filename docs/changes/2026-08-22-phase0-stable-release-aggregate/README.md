...
Base: origin/main at 3c1ad98748cb6e6834dc9a89c7b8e1de82d59e3f
...
returned no open PRs. No required Phase 0 aggregate gate lists an active owner
PR in this refresh. PR #662, PR #665, and PR #666 are now merged into the
audited mainline input after the previous aggregate refresh.
Merged PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #666
...
Merged
PR #569 through PR #575, PR #577 through PR #626, and PR #628 through PR #666
...
gate hardening, and current-main no-Host clipboard/file-transfer dialog
evidence.
...
| Protocol v1 contract and CI gates | pass | none | Current main at `3c1ad98748cb6e6834dc9a89c7b8e1de82d59e3f` is bound by this source audit. The retained push workflow snapshot records Phase 0 checks run `34120456261` completed successfully for protocol, evidence-tools, phase3, Android, and macOS jobs. |
| Android tests and debug APK clean build | pass | none | Current main at `3c1ad98748cb6e6834dc9a89c7b8e1de82d59e3f` includes PR #656 latency validator hardening, PR #657 incoming file-offer readability, PR #658 audio readiness Settings status, PR #659 clipboard confirmation dialog handling, PR #660 outgoing file-transfer confirmation, PR #663 file-transfer artifact role hardening, PR #664 clipboard artifact reuse rejection, PR #665 file-transfer smoke evidence gate hardening, and PR #666 current-main no-Host dialog layout evidence after the previous aggregate refreshes. These are source/unit/offline/tooling or no-Host readiness updates and are not treated as Host-backed product evidence; Phase 0 checks run `34120456261` completed the Android job successfully. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `3c1ad98748cb6e6834dc9a89c7b8e1de82d59e3f` is bound by this source audit. Phase 0 checks run `34120456261` completed the macOS job successfully. Local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected, so it is not a replacement XCTest pass. |
...
readiness Settings source/UI coverage only. PR #661, PR #663, PR #664, and PR
#665 are included as clipboard/file-transfer evidence-tool hardening only. PR
#666 is included as no-Host clipboard/file-transfer dialog evidence only. These
updates do not convert any
...
`3c1ad98748cb6e6834dc9a89c7b8e1de82d59e3f`, records no open PRs, records merged
PR #569 through PR #575, PR #577 through PR #626, and
PR #628 through PR #666 as `main`-targeted source/unit/offline, tooling,
...
#661, PR #663, PR #664, and PR #665 contribute clipboard/file-transfer
evidence-tool hardening only. PR #666 contributes no-Host dialog evidence only.
They do not close Host/TCC, Host RSS, native pointer HID,
controller runtime, clipboard product E2E, file-transfer product E2E, or real
Android/macOS audio E2E gates. PR #568, PR #576, PR #627, PR #646, and
PR #655 are explicitly excluded from the complete audited PR #568 through PR
#666 range because they are not merged in the audited mainline base. The retained current
refresh summary bundle is under
`evidence/2026-09-07-after-666-current-main-gate-blocked/`; local verification
