...
Base: origin/main at 170be3fc46c5560259259954c2799dfed7995e7b
...
returned no current open PRs (`[]`). PR #628 is now merged into the audited
mainline input, along with PR #623, PR #624, PR #625, and PR #626. Merged PR
#569 through PR #575 and PR #577 through PR #628 were collected with `--base main`,
...
through PR #575 and PR #577 through PR #628 include additional Android no-Host
UI/layout evidence,
...
| Protocol v1 contract and CI gates | pass | none | Current main at `170be3fc46c5560259259954c2799dfed7995e7b` passed the Phase 0 checks workflow run `34024631706`, including protocol, phase3, Android, evidence-tools, and macOS jobs. |
| Android tests and debug APK clean build | pass | none | Current main at `170be3fc46c5560259259954c2799dfed7995e7b` passed the Android job in Phase 0 checks workflow run `34024631706`; merged PR #569 through PR #575 and PR #577 through PR #628 add focused Android verification and no-Host/source readiness, including PR #621 host-unreachable/route-unavailable guidance JVM coverage, PR #622/#624/#626/#628 aggregate evidence refreshes, PR #623 P0110 no-Host UI/UX review evidence, and PR #625 Host TCC identity preflight tightening, but are not treated as Host-backed product evidence. |
| macOS release build and full-Xcode unit tests | pass | none | Current main at `170be3fc46c5560259259954c2799dfed7995e7b` passed the macOS job in Phase 0 checks workflow run `34024631706`. Local 2026-08-28 full-Xcode readiness remains blocked because that machine had Command Line Tools selected, so it is not a replacement XCTest pass. |
...
`170be3fc46c5560259259954c2799dfed7995e7b`, records the current open-PR
snapshot as empty, consumes current-main Phase 0
checks run `34024631706`, records merged PR #569 through PR #575 and PR #577
through PR #628 as `main`-targeted source/unit/offline or no-Host readiness after
