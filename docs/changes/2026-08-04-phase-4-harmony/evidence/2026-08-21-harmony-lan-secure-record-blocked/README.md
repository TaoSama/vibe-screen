...
Date: 2026-08-21
Current-base replay: 2026-08-26 on `codex/pr202-harmony-secure-record-current-base`
...
rejection, channel relabel rejection, tamper rejection, invalid sender or channel
rejection, closed-session rejection, and explicit legacy plaintext fallback
labeling.
