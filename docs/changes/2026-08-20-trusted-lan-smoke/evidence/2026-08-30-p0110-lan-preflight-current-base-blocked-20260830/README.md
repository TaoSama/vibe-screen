...
`.claude/worktrees/trusted-lan-p0110-current-base-20260830`. The real-device
...
because stable signing failed, and no TCP `54321` listener was observed at
preflight time; loopback-only listeners are not LAN evidence.
