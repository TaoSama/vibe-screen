# Protocol v1 Clipboard Main Audit

## Scope

This record audits current `origin/main` for Android <-> macOS Protocol v1
clipboard status after the README matrix showed an E2E gap. It is a source and
...
Commands were run from this worktree on 2026-08-21.
...
Result: `Ran 16 tests in 61.121s OK`, including
