...
Shared Host readiness reports can_start_controller_runtime_gate=false. Shared Host readiness blockers recorded: 5; see host-readiness.json for details. No physical Android gamepad/joystick source is visible in dumpsys input. This is readiness evidence only; a pass still requires live controller samples, Protocol v1 controller negotiation, Mac-side response, and neutral release on disconnect.
