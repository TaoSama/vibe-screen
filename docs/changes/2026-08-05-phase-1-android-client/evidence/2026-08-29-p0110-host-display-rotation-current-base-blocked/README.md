...
`1435825b02362626341e0143509811591b2bbf15`, then uses tooling commit
`ee88f9a299855d3705cf5edd877ed70213d6458b` so the current-base manifest can
ignore only its own evidence output directory while still rejecting unrelated
repository dirtiness. The manifest records `dirty=false` and an empty
`status_porcelain` after applying that fix.
