    ...
    checks = [
        ...
        CheckResult(
            ...
            status="pass" if all(
                ...
                for needle in (".hdrVideo", ".audio", ".audioDataChannel", ".bulkDataChannel", ".multiClient")
            ) else "fail",
            detail="HDR, audio, audio/bulk DataChannel, and multi-client stay out of productionHostCapabilities defaults",
        ),
        check_required_text(
