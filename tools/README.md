...
The CLI is deliberately fail-closed. It requires a real iPhone or iPad, signed
app install, physical keyboard, hover or pointer accessory, Protocol v1 session
