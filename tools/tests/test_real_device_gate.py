...
class RealDeviceGateTests(unittest.TestCase):
    ...
    def test_cli_exits_two_for_blocked_report(self) -> None:
        with tempfile.TemporaryDirectory() as directory, mock.patch(
            ...
            exit_code = main(["--serial", "EP0110PZ0B9110300B", "--output", str(output)])
    ...
    def _adb_success(command):
        ...
        values = {
            ...
            ("shell", "getprop", "ro.serialno"): "EP0110PZ0B9110300B\n",
            ("reverse", "--list"): "EP0110PZ0B9110300B tcp:54321 tcp:54321\n",
