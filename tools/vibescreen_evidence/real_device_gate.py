...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if document["result"] == "ready":
        return 0
    print(f"{document['result']}: " + "; ".join(document["blockers"] + document["insufficiencies"]), file=sys.stderr)
    return 2 if document["result"] == "blocked" else 1
