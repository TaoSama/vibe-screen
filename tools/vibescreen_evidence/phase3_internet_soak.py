    ...
    *,
    ...
    return {
        ...
        "deployment": {
            ...
            "tls_certificate_sha256": _non_empty(tls_certificate_sha256, "--tls-certificate-sha256"),
        ...
        "build": {
            ...
            "android_artifact_sha256": _non_empty(android_artifact_sha256, "--android-artifact-sha256"),
        },
        "session": {
...
def _evaluate_manifest(manifest: dict[str, Any] | None, reasons: list[str]) -> dict[str, Any]:
    ...
    manifest_checks = {
        ...
        "tls_fingerprint": isinstance(deployment.get("tls_certificate_sha256"), str) and len(deployment.get("tls_certificate_sha256", "")) >= 32,
