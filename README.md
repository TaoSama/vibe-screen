...
- Harden window migration/return, disconnect recovery, automatic reconnect,
  ...
  [no-Host P0110 current-main UI/UX record](docs/changes/2026-08-22-android-ui-ux-audit/evidence/2026-09-08-nubia-p0110-no-host-uiux-current-main/README.md)
...
- The macOS Host and Android client now share a transport-neutral, bounded
  ...
  [2026-09-08 P0110 no-Host current-main UI/UX refresh](docs/changes/2026-08-22-android-ui-ux-audit/evidence/2026-09-08-nubia-p0110-no-host-uiux-current-main/README.md),
