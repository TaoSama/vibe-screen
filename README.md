...
- The macOS Host and Android client now share a transport-neutral, bounded
  ...
  not real bidirectional file transfer; no Android real-device file-transfer
