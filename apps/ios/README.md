...
The phase5-host-advanced-adapters-gate readiness contract records the advanced
host integration expectations without closing device acceptance. The baseline
