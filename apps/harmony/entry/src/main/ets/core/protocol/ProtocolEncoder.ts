import { Capability, ClientHello, Codec, ColorDescription, ControllerInput, EnvelopeMetadata, InputTarget, KeyInput,
  NormalizedInput, PROTOCOL_VERSION, ScrollInput, StylusInput, TransportKind, VideoConfig } from './ProtocolModels';
