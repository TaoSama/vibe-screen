...
non-neutral lifecycle, and the four-active-controller limit without assigning
wire bytes to invalid input. The limit records its stable per-input rejection
reason and requires the receiver to preserve the session and admitted devices.
