...
| [stasel WebRTC](https://github.com/stasel/WebRTC) | tag `150.0.0`, package commit `6ed87f05368632f71dc95c89c14c051561710925`, Google WebRTC source commit `1f975dfd761af6e5d76d28333191973b258d82a8`; XCFramework checksum `f9890492b0016e4c88ab20f07867b8b420054caedc8a692b2ec6ac041f3cf6b2` | WebRTC BSD-3-Clause plus statically linked component terms | macOS SwiftPM binary dependency for Phase 3 ICE/DTLS/SCTP/DataChannel; no source is copied. The top-level license, immutable provenance, and an explicitly conservative M150 component notice superset are retained in the MacHost resource bundle and release notices archive. The notice bundle is generated from the exact source revision's license map, records each component repository/revision/path/text SHA-256, has SHA-256 `896890245459abac28f8b7223f6c68090ffe3447ec95fa8ef99045e88737d3b7`, and is represented by component packages in the aggregate SPDX SBOM. |
...
| [pgx](https://github.com/jackc/pgx) | module `github.com/jackc/pgx/v5` version `v5.7.5` | MIT | Go runtime dependency for relay and authority PostgreSQL connectivity; source is resolved by Go modules and not copied. |
