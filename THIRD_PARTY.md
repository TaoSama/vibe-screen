...
| [SwiftProtobuf](https://github.com/apple/swift-protobuf) | tag `1.32.0`, commit `c6fe6442e6a64250495669325044052e113e990c` | Apache-2.0 with runtime-library exception | iOS SwiftPM runtime for generated Protocol v1 types; runtime source is resolved rather than copied. The exact upstream license is retained at `apps/ios/ThirdPartyLicenses/SwiftProtobuf-LICENSE.txt` (SHA-256 `186c5f0192a754714a7e542233ddaaad28745626e0ad32e358d3f5af00afb84a`) and bundled by the iOS project. |

## Build-time dependencies

| Project | Immutable source | License | Use and copy status |
| --- | --- | --- | --- |
| [Protocol Buffers compiler](https://github.com/protocolbuffers/protobuf) | tag `v32.1`, commit `7fcfd66022455635fa29af92987cdc0967efd4f3` | BSD-3-Clause | Build-time generator for iOS Protocol v1 `*.pb.swift`; compiler source and binary are not copied. Generated files derive from this repository's schemas. |
