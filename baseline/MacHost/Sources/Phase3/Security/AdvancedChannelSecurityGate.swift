...
final class AdvancedChannelSecurityGate {
    ...
    init(owner: AdvancedChannelOwner, limits: Limits = .standard) throws {
        guard owner.isValid else { throw AdvancedChannelSecurityError.invalidOwner }
