...
enum StreamInputMapping {
    ...
    /// Covers letters, digits, punctuation, whitespace, arrows, editing keys,
    /// F1-F12, and the ANSI numeric keypad.
    private static let hidUsageToMacKeyCode: [UInt32: Int] = [
        ...
        0x44: 0x67, 0x45: 0x6F,
        0x49: 0x72, 0x4A: 0x73, 0x4B: 0x74, 0x4C: 0x75, 0x4D: 0x77,
        0x4E: 0x79, 0x4F: 0x7C, 0x50: 0x7B, 0x51: 0x7D, 0x52: 0x7E,
