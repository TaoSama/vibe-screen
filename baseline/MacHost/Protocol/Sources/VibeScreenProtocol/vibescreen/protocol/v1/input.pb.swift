...
/// in one negotiated session. A receiver must reject a CONNECTED event that
/// would exceed this limit with an InputAck whose accepted field is false and
/// rejection_reason is "maximum_active_controllers_exceeded", without closing
/// the session or changing any admitted controller lifecycle.
