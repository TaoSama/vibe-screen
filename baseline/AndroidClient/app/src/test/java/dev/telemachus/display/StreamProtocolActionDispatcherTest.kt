...
class StreamProtocolActionDispatcherTest {
    ...
    private class RecordingProtocolActionSink : StreamProtocolActionDispatcher.Sink {
        ...
        override fun onFileOfferReceived(out: DataOutputStream, session: ProtocolV1Session, offer: FileOffer) {
            events += "file-offer:" + offer.transferId.toStringUtf8()
        }
        ...
        override fun onFileCompleteReceived(result: FileTransferComplete) {
