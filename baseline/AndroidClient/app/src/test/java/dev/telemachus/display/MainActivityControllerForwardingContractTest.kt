...
class MainActivityControllerForwardingContractTest {
    ...
    fun controllerDispatchUsesNegotiatedSessionBindingAndStreamClientSink() {
        ...
        assertContains(internetDispatch, "orderedDispatch.samples.map { sample -> ProductControllerEvent(internetInputIds.next(), sample) }")
        ...
        assertBefore(internetDispatch, "ControllerDispatchOrdering.disconnectsBeforeLaterEpochSamples(dispatch)", "ProductControllerEvent(internetInputIds.next(), sample)")
