    ...
    fun lanSendClipboardConfirmationDialogActionButtonsWrapAndMeetTouchTarget() {
        listOf(
            ...
            withClipboardConfirmationDialog(
                ...
                val positive = checkNotNull(dialog.getButton(AlertDialog.BUTTON_POSITIVE)) { "positive button exists" }
                val negative = checkNotNull(dialog.getButton(AlertDialog.BUTTON_NEGATIVE)) { "negative button exists" }
            ...
            withClipboardConfirmationDialog(
                ...
                checkNotNull(dialog.getButton(AlertDialog.BUTTON_POSITIVE)) { "positive button exists" }.performClick()
            }
