...
/** One reentrant ordering gate for message-id allocation, encoding, and reliable control send. */
internal class InternetControlSendLinearizer {
    private val lock = ReentrantLock()

    fun <T> withGate(operation: () -> T): T = lock.withLock(operation)
}
